...
const vocabularyData = {
  "问候": [
    ...
    { chinese: "告辞", thai: "ลาก่อน" },
    { chinese: "对不起", thai: "ขอโทษ" },
    { chinese: "没关系", thai: "ไม่เป็นไร" },
    { chinese: "再见", thai: "เจอกัน" },
    { chinese: "失陪", thai: "ขอตัว" },
    { chinese: "请", thai: "เชิญ" },
    { chinese: "你好吗", thai: "สบายดีไหม" },
    { chinese: "我很好", thai: "สบายดี" }
  ],
  "称呼": [
    { chinese: "我（男女都可用，一般女性用）", thai: "ฉัน" },
    { chinese: "我（男性用）", thai: "ผม" },
    { chinese: "你，您", thai: "คุณ" },
    { chinese: "您，怹（尊贵之人）", thai: "ท่าน" },
    { chinese: "我（老子/老娘，要么是熟人要么是骂人，平时最好别用）", thai: "กู" },
    { chinese: "你（要么是熟人要么是骂人，平时最好别用）", thai: "มึง" },
    { chinese: "你（比较熟的朋友之间）", thai: "แก" },
    { chinese: "他，人家（第三人称泛指，也可以用于自称）", thai: "เขา" },
    { chinese: "我（非常正式）", thai: "ดิฉัน" },
    { chinese: "他", thai: "เขา" },
    { chinese: "Nhu，晚辈/小孩的自称或者长辈称晚辈", thai: "หนู" },
    { chinese: "她，你（亲近之人）", thai: "เธอ" },
    { chinese: "它", thai: "มัน" },
    { chinese: "我们,我（没那么正式也不会不礼貌）", thai: "เรา" },
    { chinese: "们（加在其他称呼前表示复数）", thai: "พวก" },
    { chinese: "老师", thai: "ครู" },
    { chinese: "医生", thai: "หมอ" },
